              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  ...
                  <ul class="nav nav-tabs">
                    <li class="nav-item">
                      <a class="nav-link active" href="{{route('employee.index')}}">All</a>
                    </li>
                  @foreach($department AS $args)
                  <li class="nav-item">
                      <a class="nav-link" href="{{ route('employee.single',$args->name)}}">{{ $args->name }}</a>
                    </li>
                  @endforeach
                  </ul>
                    @if(count($employee) >= 1)
                    ...
                    <table class="table">
                        ...
                        @foreach($employee AS $args)                        
                          ...
                          <td>
                            ...
                            <td> <a href="{{ route('employee.pay',$args->id) }}">Pay Now</a> </td>                            <td>                           
                            <a class="float-left" href="{{ route('employee.edit',$args->id) }}">
